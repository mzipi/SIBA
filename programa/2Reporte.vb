...
Public Class Crystal_Report12Reporte
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Nombre_Turno() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrystal_Report12Reporte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystal_Report12Reporte = New Crystal_Report12Reporte
        rpt.Site = Me.Site
        Return rpt
    End Function
