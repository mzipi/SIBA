Public Class altagrupo
    ...
    Private Sub Form18_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case accion
            ...
            Case acciones.modificar
                ...
                lbltitulo.Text = "MODIFICACIÓN DE GRUPO"
                With ungrupo
    ...
    Private Sub btnaceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnaceptar.Click
        ...
        If (cmbaño.SelectedIndex = 0) Then
            MsgBox("Debe ingresar un año para el grupo")
        ...
        If (cmbcarrera.SelectedIndex <> 0 And txtcodgrupo.Text <> "" And cmbturno.SelectedIndex <> 0 And cmbaño.SelectedIndex <> 0 And txtcurso.Text <> "" And txtletra.Text <> "") Then
            ...
            If (accion = acciones.ingresar) Then
                ...
                If ds.Tables("grupos").Rows.Count > 0 Then
                    MsgBox("Ya existe un grupo ingresado con esa  combinación")
                    controla = 1
                End If
            End If
        End If
        ...
        If accion = acciones.eliminar Then
            ...
            If (controla <> 1) Then
                ...
                Dim cx As New Odbc.OdbcConnection
                Dim cm As New Odbc.OdbcCommand
                Select Case MsgBox("Está seguro de eliminar el grupo " + cmbaño.SelectedItem + txtcurso.Text + txtletra.Text + "?", MsgBoxStyle.YesNo)
