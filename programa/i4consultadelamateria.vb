...
Public Class i4consultadelamateria
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "i4consultadelamateria.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Career() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedi4consultadelamateria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As i4consultadelamateria = New i4consultadelamateria
        rpt.Site = Me.Site
        Return rpt
    End Function
