...
Public Class Crystal_Report14Reporte
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Carrera() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrystal_Report14Reporte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystal_Report14Reporte = New Crystal_Report14Reporte
        rpt.Site = Me.Site
        Return rpt
    End Function
