    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnconf.Click
        ...
        If (cmbdocente.SelectedIndex <> 0 And cmbturno.SelectedIndex <> 0 And cmbgrupos.SelectedIndex <> 0 And cmbcarrera.SelectedIndex <> 0 And cmbmat.SelectedIndex <> 0) Then
            ...
            If ds.Tables("tienen").Rows.Count = 0 Then
                Select Case MsgBox("No está asociada la materia con el grupo. Desea asociarla para poder asignar al docente  ." + cmbdocente.SelectedItem + "?", MsgBoxStyle.YesNo)
                    Case MsgBoxResult.Yes
                        ...
                        MsgBox("Grupo, materia asociados correctamente. Se asignará el docente.")
                        ...
                        MsgBox("Docente asignado exitosamente")
                    ...
                    Case MsgBoxResult.No
                        MsgBox("No se asignará el docente al grupo y la materia solicitada ya que no están asociadas la materia con el grupo")
            ...
            Else
                MsgBox("Ya está asociada la materia con el grupo. Se comprobará si se puede asignar al docente")
                ...
                If ds4.Tables("docente").Rows.Count > 0 Then
                    MsgBox("Ya existe un  docente asignado a ese grupo. Verifique los datos")
                    cx4.Close()
                    abmdocentes.Show()
                    Me.Close()
                    cmbdocente.Items.Clear()
